  ...
  <div>
    ...
    <van-sticky :offset-top="55">
      <div v-if="state==1" style="position: relative;">
        <van-tabs v-model="active" :ellipsis=false line-width="25%" @click="jqTab_select" style="font-size: 14px;"
          color="#2796e7" title-inactive-color="#999999" title-active-color="#2796e7">
    ...
    <van-sticky :offset-top="55">
      <div v-if="state==2" style="position: relative;">
        <van-tabs v-model="active" :ellipsis=false line-width="25%" style="font-size: 14px;" color="#2796e7"
          @click="jqTab_select" title-inactive-color="#999999" title-active-color="#2796e7">
