<template>
  <ul style="margin-top: 75px;">
    <li class="li_class">
      ...
      <div class="block_div_style" style="margin-top:5px;">
        ...
        <div class="block_div_style">
          ...
          <div class="li_div_title2_red">天</div>
        </div>
      </div>
      <div class="block_div_style" style="margin-top:5px;">
        <div class="li_div_title2">本年优良天数占比</div>
        <div class="block_div_style">
      ...
      <div style="position:relative;height:27px;margin-top:8px;">
        <div class="zdgc_lk_bg">晋城市环保局</div>
    ...
    <li class="li_class">
      ...
      <div class="block_div_style" style="margin-top:5px;">
        <div class="li_div_title2">巡查次数</div>
        <div class="block_div_style">
          <div class="li_div_title3_red">{{dataArrList[3]}}</div>
          <div class="li_div_title2_red">次</div>
        </div>
      </div>
      <div class="block_div_style" style="margin-top:5px;">
        <div class="li_div_title2">办结问题数</div>
        <div class="block_div_style">
