              ...
              <div style="padding:7px;">
                ...
                <div style="display:flex;position:relative;">
                  ...
                  <div style="margin-left: 10px;margin-top: -11px;">
                    <img
                      class="mt_wsdjImg"
                      v-if="item.gas_level == 1"
                      src="../../../../../assets/img/mt-tc.png"
                    />
                    <img
                      class="mt_wsdjImg"
                      v-if="item.gas_level == 2"
                      src="../../../../../assets/img/mt-gws.png"
                    />
                    <img
                      class="mt_wsdjImg"
                      v-if="item.gas_level == 3"
    ...
    >
      <div style="background:#ffffff;">
        ...
        <ul class="ui-row" id="qyxzListDialogId" style="margin-top: 11px;margin-right: 0px;">
          <li
            v-for="(item,index) in qyxz_dataList"
            style="width: 26%;"
            :key="index"
            :id="(item.typecode)"
        ...
        <div style="display: flex;background: #f3f3f3;height:110px;">
          <div
            @click="clearType"
            style="width: 50%;height: 36px;background: #ffffff;line-height: 36px;text-align: center;font-size:15px;"
          >重置</div>
          <div
            @click="clickUlDy"
            style="background:#3ca1ec;width: 50%;height: 36px;color:#ffffff;line-height: 36px;text-align: center;font-size:15px;"
          >确定</div>
        </div>
      </div>
    </van-popup>
