    ...
    <div style="margin-top:0px;overflow:hidden;">
        ...
        <mescroll-vue ref="mescroll" :down="mescrollDown" :up="mescrollUp" @init="mescrollInit">
            <div id="newsList"
                ...
                <div v-for="(item,index) in pro_dataList" :key="index" @click="goDetail(item)"
        ...
        <van-popup v-model="show" position="top" get-container="#count_id" :style="{ height: '42%' }" @opened="openPop"
            ...
            <div style="background:#ffffff;">
                ...
                <ul class="ui-row" id="jsxzListDialogId" style="margin-top: 11px;margin-right: 0px;">
                    <li v-for="(item,index) in jsxz_dataList" style="width: 30%;" :key="index" :id="(item.typecode)"
                ...
                <ul class="ui-row" id="ktfsListDialogId" style="margin-top: 11px;margin-right: 0px;">
                    <li v-for="(item,index) in ktfs_dataList" style="width: 26%;" :key="index" :id="(item.typecode)"
                        class="ui-col ui-col-25 dialogNoSelect">{{item.typename}}</li>
                </ul>
