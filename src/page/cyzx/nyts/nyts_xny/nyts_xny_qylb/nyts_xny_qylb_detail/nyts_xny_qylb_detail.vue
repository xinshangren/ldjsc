<style scoped>
.xny_qylb_deali_content_font_style {
  font-size: 15px;
  margin-top: 8px;
  margin-left: 18px;
}
    ...
    <div style="background:#ffffff;height:auto;width:100%;margin-top:5px;">
      <div style="margin: 10px 20px 10px 20px; padding-top:10px;" id="compDetail">
        ...
        <div style="margin-top: 10px;font-size:15px;">
          <img
            class="xny_qyxq_qyxzImg"
            v-if="compDetail.ent_nature == 1"
            src="../../../../../../assets/img/xny-qy-gyqy.png"
          />
          <img
            class="xny_qyxq_qyxzImg"
            v-if="compDetail.ent_nature == 2"
            src="../../../../../../assets/img/xny-qy-jtsyzqy.png"
          />
          <img
            class="xny_qyxq_qyxzImg"
            v-if="compDetail.ent_nature == 3"
            src="../../../../../../assets/img/xny-qy-lyqy.png"
          />
          <img
            class="xny_qyxq_qyxzImg"
            v-if="compDetail.ent_nature == 4"
            src="../../../../../../assets/img/xny-qy-szqy.png"
          />
          <img
            class="xny_qyxq_qyxzImg"
            v-if="compDetail.ent_nature == 5"
            src="../../../../../../assets/img/xny-qy-syqy.png"
          />
          <img
            class="xny_qyxq_qyxzImg"
            v-if="compDetail.ent_nature == 6"
            src="../../../../../../assets/img/xny-qy-qtqy.png"
          />

          <img
            class="xny_qyxq_qygmImg"
            v-if="compDetail.ent_scale == 1"
            src="../../../../../../assets/img/xny-qy-dx.png"
          />
          <img
            class="xny_qyxq_qygmImg"
            v-if="compDetail.ent_scale == 2"
            src="../../../../../../assets/img/xny-qy-zx.png"
          />
          <img
            class="xny_qyxq_qygmImg"
            v-if="compDetail.ent_scale == 3"
            src="../../../../../../assets/img/xny-qy-xx.png"
          />

          <img
            class="xny_qyxq_qylxImg"
            v-if="compDetail.ent_type == 1"
            src="../../../../../../assets/img/xny-qy-gd.png"
          />
          <img
            class="xny_qyxq_qylxImg"
            v-if="compDetail.ent_type == 2"
            src="../../../../../../assets/img/xny-qy-fd.png"
          />
          <img
            class="xny_qyxq_qylxImg"
            v-if="compDetail.ent_type == 3"
            src="../../../../../../assets/img/xny-qy-swzfd.png"
          />
          <img
            class="xny_qyxq_qylxImg"
            v-if="compDetail.ent_type == 4"
            src="../../../../../../assets/img/xny-qy-sd.png"
          />
          <img
            class="xny_qyxq_qylxImg"
            v-if="compDetail.ent_type == 5"
        ...
        <div style="margin-top: 10px;">
          <div>
            ...
            <div class="xny_qylb_deali_content_font_style">
          ...
          <div style="width: 50%;float: right;margin-top: 15px;">
            ...
            <div  class="xny_qylb_deali_content_font_style">
              <span style="">{{compDetail.legal_behalf}}</span>
            </div>
          </div>
          <div style="width: 50%;float: left;margin-top: 15px;">
            <div>
            ...
            <div  class="xny_qylb_deali_content_font_style">
              <span style="">{{compDetail.phone_contacts}}</span>
            </div>
          </div>
          <div style="width: 50%;float: right;margin-top: 15px;">
            <div>
            ...
            <div  class="xny_qylb_deali_content_font_style">
              <span style="">{{compDetail.institution_code}}</span>
            </div>
          </div>
