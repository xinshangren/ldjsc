          ...
          <div style="padding:7px;">
            ...
            <div style="display:flex;position:relative;font-size:15px;">
              ...
              <div style="margin-left: 10px;margin-top:3px;">
                ...
                <img
                  class="xny_qygmImg"
                  v-if="item.ent_scale == 2"
                  src="../../../../../assets/img/xny-qy-zx.png"
                />
                <img
                  class="xny_qygmImg"
                  v-if="item.ent_scale == 3"
              ...
              <div style="margin-left: 10px;margin-top:3px;">
                ...
                <img
                  class="xny_qylxImg"
                  v-if="item.ent_type == 3"
                  src="../../../../../assets/img/xny-qy-swzfd.png"
                />
                <img
                  class="xny_qylxImg"
                  v-if="item.ent_type == 4"
                  src="../../../../../assets/img/xny-qy-sd.png"
                />
                <img
                  class="xny_qylxImg"
                  v-if="item.ent_type == 5"
    ...
    >
      <div style="background:#ffffff;">
        ...
        <ul class="ui-row" id="qylxListDialogId" style="margin-top: 11px;margin-right: 0px;">
          <li
            v-for="(item,index) in qylx_dataList"
            style="width: 26%;"
            :key="index"
            :id="(item.typecode)"
        ...
        <ul id="qygmListDialogId" class="ui-row" style="margin-top: 11px;margin-right: 0px;">
          <li
            v-for="(item,index) in qygm_dataList"
            :key="index"
            :id="(item.typecode)"
            class="ui-col ui-col-25 dialogNoSelect"
          >{{item.typename}}</li>
