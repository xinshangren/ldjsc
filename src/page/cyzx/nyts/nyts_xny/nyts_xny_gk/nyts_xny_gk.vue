        ...
        <div style="width: 76%;">
          <div style="float: left; ">
            ...
            <div style="float: right;margin-left: 10px;">
              <p class="xny_gk_font_style" style="line-height: 22px;">光伏</p>
              <p  class="xny_gk_font_style" style="line-height: 22px;">
          ...
          <div style="float: right;margin-right: 33px;">
            ...
            />
            <div style="float: right;margin-left: 10px;">
              <p  class="xny_gk_font_style" style="line-height: 22px;">水电</p>
              <p class="xny_gk_font_style" style="line-height: 22px;">
          ...
          <div style="clear: both; float:left;margin-top: 17px; ">
            ...
            />
            <div style="float: right;margin-left: 10px;">
              <p class="xny_gk_font_style" style="line-height: 22px;">风电</p>
              <p class="xny_gk_font_style" style="line-height: 22px;">
          ...
          <div style="float: right;margin-top:17px;margin-right: -17px;  ">
            ...
            />
            <div style="float: right;margin-left: 10px;">
              <p class="xny_gk_font_style" style="line-height: 22px;">生物质发电</p>
              <p class="xny_gk_font_style"  style="line-height: 22px;">
          ...
          <div style="float: left;margin-top:17px;margin-right: 33px;  ">
            ...
            />
            <div style="float: right;margin-left: 10px;">
              <p class="xny_gk_font_style" style="line-height: 22px;">其他</p>
              <p class="xny_gk_font_style" style="line-height: 22px;">
...
<style scoped>
@import "../../../../../page/cyzx/nyts/nyts_xny/nyts_xny_gk/nyts_xny_gk.css";
