<template>
  ...
  <div>
    <van-list id="newslist2" v-model="loading" :finished="finished" @load="onLoad" :offset="60" :error.sync="error" error-text="查询失败"
  ...
  export default {
    ...
    mounted() {
      var orderHight1 =document.documentElement.clientHeight;
        ...
        document.getElementById("newslist2").style.height=heightlist+"px"
        this.gojq()
    },
    methods: {
