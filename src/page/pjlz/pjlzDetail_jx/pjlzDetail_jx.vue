...
<template>
    <div style="margin-top:54px;background:#f7f7f7">
            ...
            <div style="padding:10px 15px 0px 15px;position: relative;">
                ...
                <div style="display: flex;">
                    ...
                    height: 40px;">
                        ...
                        <div style="margin-top: 9px; margin-left: 3px; color: #ffffff;font-size: 15px;">同意结项</div>
                    </div>
                </div>
            </div>
        </div>
        <van-popup v-model="show" round style="border-radius:13px">
            <div id="refuse_div">
                <img @click="close" style="height: 25px; position: absolute;right: 0px;"
                ...
                <div style="margin-top:5px;margin-left: 20px;display: flex;width: 257px;">
                    ...
                    margin: auto;
                    height: 35px;">
                        <div style="margin-top: 6px; margin: auto; color: #ffffff;font-size: 15px;">提交</div>
                    </div>
                </div>
            </div>
        </van-popup>
