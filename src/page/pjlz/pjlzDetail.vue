  ...
  <div>
    <div id="pjlzDeali_fk_id" style="margin:101px 0px 10px;background:#ffffff;min-height: 210px;">
      <div style="display: flex;padding-top: 10px;">
        ...
        <div style="font-weight: 600;font-size: 18px; padding:7px 7px 7px 7px;width: 85%;margin: auto;">
      ...
      <div style="color: #666666;font-size: 16px;width: 94%;">
        <div style="display: flex;margin-top: 10px;">
          <div style="width: 37%;text-align: left; display: flex;">
            <!-- <img src="../../assets/img/wh.png" style="height: 16px;margin: 3px;" /> -->
            <div class="title">文号：</div>
          </div>
          <div style="width:63%">{{pj_detail.approval_number}}</div>
        </div>
        <div style="display: flex;margin-top: 15px;position: relative;">
          <div style="width: 37%;text-align: left; display: flex;">
            <!-- <img src="../../assets/img/wjnr.png" style="height: 16px;margin: 3px;" /> -->
            <div class="title">文件内容：</div>
          </div>
          <span style="position: absolute;
          top: 27px;
          font-size: 13px;left: 9px;
    width: 31%;">（点击内容放大）</span>
          <div style="width: 63%;height: 100px;overflow-y:scroll;">
            <div style="font-size: 16px;
                        line-height: 23px;
                       " v-html="pj_detail.approval_content" @click="pjDetail"></div>
          </div>
        </div>
        <div style="display: flex;margin-top: 15px;">
          <div style="width: 37%;text-align: left;display: flex;">
            <!-- <img src="../../assets/img/pswj.png" style="height: 16px;margin: 3px;" /> -->
            <div class="title">批示件类型：</div>
          </div>
          <div style="width:63%">{{pj_detail.approval_type}}</div>
        </div>
        <div style="display: flex;margin-top: 15px;">
          <div style="width: 37%;text-align: left;display: flex;">
            <!-- <img src="../../assets/img/cbr.png" style="height: 16px;margin: 3px;" /> -->
            <div class="title">承办人：</div>
          </div>
          <div style="width:63%">
            <div style="height: 25px;">{{pj_detail.approval_main_person}}</div>
            <div v-if="pj_detail.approval_manage_person" style="min-height:25px;">{{pj_detail.approval_manage_person}}
            </div>
          </div>
        </div>
            ...
            <div v-for="(attach,index) in pj_detail.attachlist" :key="index"
              ...
              <div v-if="index == 0" style="margin-top:0px;display: flex;width: 100%;">
                ...
                <a :href="attach.attach_download_url" download
                  ...
                  <img style="height: 16px;margin: auto;margin-left: 9px;"
    ...
    <van-popup v-model="pj_content" round closeable :style="{ height: '80%',width:'83%'}">
      <div style="height: 98%;">
        ...
        <div v-html="pj_detail.approval_content"
          style="overflow-y: auto;margin:12px 10px 0px 10px;height:90%;font-size:16px"></div>
      </div>
    </van-popup>
  </div>
</template>
