<template>
  <div>
    <div
      style="display: flex;margin: 15px;height:120px;padding: 10px;border: 1px solid #EAEAEA;background: #ffffff;"
    >
      <img
        id="ldzc_head_img_id"
        :src="data.imgUrl"
        style="width: 69px;height:95px;margin-top: 10px;"
      />
      <div style="margin-left: 4px;height: 100px;width: 80%;">
        ...
        ></div>
        <div
          id="ldjj_summary_xx_id"
          style="text-align: right; color: #1976D3;font-size: 13px;"
          @click="goxiangxi()"
        >【详细】</div>
      </div>
    </div>
    <div
      id="ldzc_ldcx_content_Id"
    ...
    >
      ...
      <div style="background: #ffffff;padding: 4px;display: flex;">
        ...
        <ul class="ui-row" style="width: 100%;margin-right: 15px;">
          <li
            id="8a87821a6b1c6361016b1c842d070007"
            class="ui-col ui-col-30 dialogNoSelect1"
            style="width:27%;"
          >孙世新</li>
        </ul>
    ...
    <div id="zxhdlistid" style="margin-top: 10px;">
      ...
      >
        ...
        >
          ...
          >{{item.title}}</div>
          <div
            style="color: #999999;font-size: 14px;overflow: hidden;height: 60px;line-height: 20px;"
          >{{item.summary}}</div>
          <div
    ...
    <div id="ldjhlistid" style="margin-top: 10px;display: none;">
      ...
      >
        <div
          style="position: relative;padding: 10px;border-bottom: 1px solid #EFEFEF; background: #ffffff;height: 95px;"
          v-for="(item1,index1) of list1"
          :key="index1"
          @click="goDetile(item1)"
        >
          <div
            style="color: #333333;font-size: 16px;width: 100%; overflow: hidden; text-overflow:ellipsis;white-space: nowrap;"
          >{{item1.title}}</div>
